 ...
 * the CMS returns nothing, is unreachable, or has unpopulated categories, so the
 * Products page is never blank and never strands the visitor on a loading message.
 *
 * This is the client's own approved copy, not placeholder data.
 */
