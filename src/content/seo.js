/**
 * Browser titles and search descriptions.
 * Source: Navora Global Website Content Pack, p. 9 — used verbatim.
 */
...
export const pageSeo = {
  ...
  products: {
    title: "Indian Food Products for Business | Navora Global",
    description:
      "Explore Navora's current product categories, including honey products, ginger, cardamom, millets and rice, and request business information.",
    path: "/products",
  },
  forBusiness: {
    title: "Food Sourcing and Distribution Partnerships | Navora Global",
    description:
      "Discuss food sourcing, wholesale, distribution, retail, private-label and market-entry opportunities with Navora Global.",
    path: "/for-business",
  },
  responsibleSourcing: {
